    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: `${prefecture}`, item: `${siteUrl}/area/${encodeURIComponent(prefecture)}` },
          { "@type": "ListItem", position: 4, name: `${ward}`, item: `${siteUrl}/area/${encodeURIComponent(prefecture)}/${encodeURIComponent(ward)}` },
        ],
      },
      {
        "@type": "FAQPage",
